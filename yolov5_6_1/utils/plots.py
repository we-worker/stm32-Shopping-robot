...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255),num=0):
        ...
        if self.pil or not is_ascii(label):
            ...
            # print("点的坐标为：(" + (p1[0]+p2[0])/2 + "，" +(p1[1]+p2[1])/2 + ")")
            cv2.rectangle(self.im, p1, p2, color, thickness=self.lw, lineType=cv2.LINE_AA)
            cv2.circle(self.im,(int((p1[0]+p2[0])/2),int((p1[1]+p2[1])/2)), 20, (255,255, 255), -1)
